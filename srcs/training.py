...
if __name__ == '__main__':
	parser = argparse.ArgumentParser(description="This program create a NN Perceptron\
	...
	parser.add_argument('-b', '--batch_size', default=1 , type=control_batchsize, action='store')
	...
	parser.add_argument('--early_stop', type=control_epochs, default=-1, help='Early stop to stop training before the number of epochs if needed')
